...
function Keller_banner(){
  echo "\e[97m
    ╔══════════════════════════════════════════════════════════════╗
    ║                                                              ║
    ║            \e[97mAzaelSS Android \e[36mDesculpa Keller ;( \e[97m                ║
    ║                \e[90mdiscord.gg/nexusbypass\e[97m                    ║
    ║                                                              ║
    ╚══════════════════════════════════════════════════════════════╝
                \e[36mCoded By: AzaelSS | Credits: ZaZa\e[0m
  \n";
}
...
function escanearFreeFire($pacote, $nomeJogo) {
    ...
    echo $bold . $branco . "\t                 Com carinho, Azael...\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
}
